...
public class FXMLDocumentController implements Initializable {
   ...
   @FXML
    ...
    @FXML
    private TextField key,text;

    @FXML
    private  Label p_or_c,lab,lab1,sub,lab11,sub1;
      @FXML
    private JFXTextField t1;

    public  void write_cipher(String s ,int pos){
    
     Label l = new Label(""+s);
                    l.setBackground(lab1.getBackground());
                    l.setFont(lab1.getFont());
                    l.setPrefSize(USE_COMPUTED_SIZE, USE_COMPUTED_SIZE);
                    l.setLayoutX(lab1.getLayoutX());
                    l.setLayoutY(lab1.getLayoutY()+22*pos);
                    l.setTextFill(lab1.getTextFill());
                    l.setId("l");
    p1.getChildren().add(l);
    }
    
    public  void write_round(String s ,int pos){
    
     Label l = new Label(""+s);
                    l.setBackground(lab11.getBackground());
                    l.setFont(lab11.getFont());
                    l.setPrefSize(USE_COMPUTED_SIZE, USE_COMPUTED_SIZE);
                    l.setLayoutX(lab11.getLayoutX());
                    l.setLayoutY(lab11.getLayoutY()+22*pos);
                    l.setTextFill(lab11.getTextFill());
                    l.setId("l");
    p1.getChildren().add(l);
    }
   @FXML private void to(ActionEvent event){
   if (!tog.isSelected() == true){
        p_or_c.setText("Plain text");}else{p_or_c.setText("Cipher text");}
    ...
    private void ok(ActionEvent event) {
        ...
        encrypt(text.getText(),key.getText());
      ...
      decrypt(text.getText(),key.getText());
	...
	{ 
		...
		System.out.println( 
			"round " + time + ": "
			+ right + left);
                write_round("round "+ time  + ": "+ right+left,time);
...
private void encrypt(String plain,String key) 
	{ 
            modVal = 1;
		...
		System.out.println("Cipher Text: " + cipherText);
               t1.setText(cipherText);
	}

private void decrypt(String plain,String key) 
	{ 
            modVal = 1;
		// storing 2^32 in modVal 
		//(<<1 is equivalent to multiply by 2) 
		...
		System.out.println("-----Encryption-----"); 
		String cipherText = decrypt(plain); 
